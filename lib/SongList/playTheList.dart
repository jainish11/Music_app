...
class PlayTheList extends StatefulWidget {
  const PlayTheList({Key? key}) : super(key: key);

  @override
  State<PlayTheList> createState() => _PlayTheListState();
}

class _PlayTheListState extends State<PlayTheList> {
  final _audioQuery= new OnAudioQuery();
  final _audioPlayer=new AudioPlayer();
  SongHelper _songHelper= SongHelper();
  final listOf=SelectSongForList();
